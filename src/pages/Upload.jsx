...
const Upload = () => {
  ...
  return (
    <>
      <div className="bg-gray-700 h-14 border-b-2 text-white border-black px-2 py-4">
        <div className="flex justify-between">
          <div className="flex gap-2 px-2">
            ...
            <div className="hidden lg:flex">60AnuragVideo.mp4</div>
          </div>
          ...
          <div>
            <div className="flex gap-4 px-2">
              <div className="bg-gray-800 border border-none rounded-md px-2 py-1">
                No status
              </div>
              <div className="bg-gray-800 border border-none rounded-md px-2 py-1">
                <svg
              ...
              <div className="bg-blue-800 border border-none rounded-md px-4 py-1">
                Share
              </div>
            </div>
          </div>
      ...
      <div className="lg:flex min-h-screen ">
        <div className=" flex-1 bg-gradient-to-r from-gray-900 to-gray-800 overflow-hidden ">
          <Video />
        </div>
        <div className=" lg:w-96 py-4 bg-gray-900 ">
          <Comment />
        </div>
      </div>
    </>
